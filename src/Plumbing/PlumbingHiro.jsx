      ...
      <div className="min-h-screen bg-gray-50 font-sans">
        ...
        <section className="max-w-6xl mx-auto px-6 py-10 flex flex-col md:flex-row items-start gap-10">
          <div className="flex-1 space-y-6">
            ...
            >
              <div
                className="flex item-center gap-2 flex-1 px-3 py-2 rounded-xl
              bg-gray-50 border border-gray-200 focus-within:border-[#FF4D7D] transition-colors"
              >
                <svg
                  viewBox="0 0 24 24"
              ...
              <div className="relative" ref={ddRef}>
                ...
                px-4 py-2 bg-gray-50 border border-gray-200 rounded-xl
                text-sm text-grat-700 hover:border-[#FF4D7D] transition-colors
