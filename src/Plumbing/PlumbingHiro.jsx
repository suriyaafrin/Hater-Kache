...
function PlumbingHero() {
  ...
  useEffect(() => {
    const handler = (e) => {
      if (e.key === "Escape") setSelectedPlumber(null);
    };
    ...
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-6">
        <nav className="flex items-center gap-2 text-sm text-gray-400">
          ...
          <span className="text-gray-300">›</span>
          <span className="text-gray-600 font-medium">Plumbing</span>
        </nav>
      </div>
        ...
        <div className="flex-1 space-y-6">
          <div>
            <h1 className="text-5xl font-extrabold text-gray-900 leading-tight tracking-tight">
              Plumbing <span className="text-blue-600">Services</span>
            </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-3 bg-white shadow-lg rounded-2xl p-2 border border-gray-100 max-w-xl">
            {/* Location */}
            <div className="flex items-center gap-2 flex-1 px-3 py-2 rounded-xl bg-gray-50 border border-gray-200 focus-within:border-blue-400 transition-colors">
              <svg
                viewBox="0 0 24 24"
            ...
            <div className="relative" ref={ddRef}>
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-gray-50 border border-gray-200 rounded-xl text-sm text-gray-700 hover:border-blue-400 transition-colors whitespace-nowrap w-full sm:w-auto"
            ...
            <button
              ...
              className="px-6 py-2.5 bg-red-500 hover:bg-red-600 active:scale-95 text-white text-sm font-semibold rounded-xl transition-all shadow-md shadow-red-200 flex items-center gap-2"
            >
              <svg
                viewBox="0 0 24 24"
                className="w-4 h-4"
