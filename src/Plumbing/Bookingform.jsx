...
import { timeOptions, requiredFields, fieldLabels,keyframeStyles } from "../../Data/PlumberData.jsx";
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm">
        <div className="bg-white rounded-3xl shadow-2xl px-8 py-10 flex flex-col items-center gap-4 max-w-xs w-full mx-4 text-center">
          ...
          <p className="text-sm text-gray-500">
            Your booking with <span className="font-semibold text-[#FF4D7D]">{mock.name}</span> has been placed successfully.
          </p>
          <button
            onClick={onClose}
      ...
      >
        ...
        >
          ...
          <div className="overflow-y-auto flex-1 px-5 py-4 space-y-4">
            ...
            {/* Description */}
            <div>
              <label className="block text-xs font-semibold text-[#1E3A5F] mb-1.5">Problem description</label>
              <div className="relative">
                <textarea
